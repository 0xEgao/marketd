...
_CONFIG_KEYS=(
    ...
    MARKETD_PORT MARKETD_WALLET_PASSWORD USE_EXTERNAL_BITCOIND USE_EXTERNAL_TOR
)
...
export_env() {
    ...
    export MARKETD_PORT MARKETD_WALLET_PASSWORD
}
...
configure_prod() {
    ...
    echo "  1) Signet  (default, where OpenSwap operates)"
    echo "  2) Mainnet"
    local net_choice
